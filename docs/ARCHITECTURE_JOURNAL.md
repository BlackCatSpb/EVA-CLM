...
- **Прогон:** `git 804b974` — продолжение с шага 5280 (T9-комплект + T9.10-сейв), seq 384, batch 1, A100 40GB, план 150k шагов.
- **Step:** 5720 (2026-09-20); **best val 8.4897** (8.63@5280 → 8.49@5720).
- **Val-траектория:** 15.78@250 → 12.02@440 → 10.39@1000 → 10.10@1760 → 9.98@2200 →
  ...
  8.63@5280 → **8.49@5720**. Спайки (500/750/2000/4400/5280) — после каждого новый best.
  **Depth-контроллер: 16/24** (плато на 5280).
...
|---|---|---|---|
| best.pt (текущий) | 5720 | **8.4897** | прогон 804b974 (T9-комплект + T9.10-сейв), depth 16/24 |
