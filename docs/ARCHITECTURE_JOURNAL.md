...
- **Прогон:** свежий, git `4725d59` (весь T9-комплект), seq 384, batch 1, A100 40GB, план 150k шагов.
...
- **Банк:** пишет с ~495 (mat 0.18→0.88); **Генерация:** smart-режим с паритетом тренировки
