...
# ── M2.2–M2.5 LayerBridgeGate tests: REMOVED (M64.5 — the dead channel) ──────
# The gate was computed and discarded, its log_tau had no gradient path and the
# B3 parity incident broke the bridge (train 0.26 vs eval 3.69 < chance). The
# module is gone; the 'health-gated bridge routing' idea is an M65 candidate.
